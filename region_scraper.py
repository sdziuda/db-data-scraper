...
voivodeshipsCsv = open("res/voivodeships.csv", "w", encoding="utf-8")
districtsCsv = open("res/districts.csv", "w", encoding="utf-8")
municipalitiesCsv = open("res/municipalities.csv", "w", encoding="utf-8")
localesCsv = open("res/locales.csv", "w", encoding="utf-8")
